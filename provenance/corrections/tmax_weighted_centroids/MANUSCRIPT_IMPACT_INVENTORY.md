...
(`provenance/corrections/tmax_weighted_centroids/` artifacts); replacement wording is cautious draft text for
...
| 4 | Results §4.x: Figure 3 caption/text (footprint maxima, spatial description) | Footprint recomputed at translated ellipses | `provenance/corrections/tmax_weighted_centroids/audit/fig3_footprint_before_after.json` | 1° analysis-grid audit (1,800 cells): max overlap 279 footprints, attained at four cells, reported at (43.5°E, 30.5°N) [was 280 at (41.5°E, 31.5°N)]; keep "PCA-ellipse footprints per grid cell" | numeric |
...
| 10 | Appendix D figure(s) (fold maps / Figure S4 family) | Regenerated | `provenance/corrections/tmax_weighted_centroids/corrected_outputs/figures/Figure_S4_kfold_heldout_maps.png` | Update panel values only | numeric |
